...
if (isset($_GET["cari"])) {
	...
	$buku = query2("SELECT * from buku where judul_buku like '%" . $_GET["keyword"] . "%' or loker_buku like '%" . $_GET["keyword"] . "%' or nama_pengarang like '%" . $_GET["keyword"] . "%' or penerbit like '%" . $_GET["keyword"] . "%'");
}
